...
import { handleProp } from '@/utils/other.ts'
  ...
  <div class="card table-main">
    ...
    <div class="table-header">
      <div class="header-button-lf">
        <slot
          name="tableHeader" :selected-list="selectedList" :selected-list-ids="selectedListIds"
      ...
      <div v-if="toolButton" class="header-button-ri">
        <slot name="toolButton">
          ...
          <el-button
            v-if="showToolButton('setting') && columns.length" :icon="Operation" circle
